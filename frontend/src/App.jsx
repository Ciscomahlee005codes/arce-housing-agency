...
function App() {
  ...
  // Combined hidden routes from both branches
  const hiddenRoutes = [
    "/login",
    "/dashboard/home",
    "/dashboard/Property",
    "/dashboard/RentalPage",
    "/dashboard/Request",
    "/dashboard/notification",
    "/agentDashboard/Home",
    "/agentDashboard/Property",
    "/agentDashboard/RentalPage",
    "/agentDashboard/Request",
    "/agentDashboard/notification",
    "/agentDashboard/Profile",
    "/agentDashboard/HelpSupport",
    "/agentDashboard/Messages",
    "/adminDashboard/Home",
    "/adminDashboard/UserManagement",
    "/adminDashboard/AdminManagement",
