...
import { hostel_List } from "../../../house_List";
import "./HostelDetails.css";

const HostelDetails = () => {
  const { id } = useParams();
  const hostel = hostel_List.find((h) => h.id.toString() === id);
  ...
  return (
    <div className="details-container">
      ...
      <div className="details-info">
        ...
        <p><strong>Annual Rent:</strong> {hostel.rent}</p>
        <p><strong>Description:</strong> {hostel.description || "No description available."}</p>
      </div>

      <div className="btn-container">
        <button onClick={() => setShowModal(true)}>Book a Hostel Tour</button>
