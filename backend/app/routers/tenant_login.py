...
from app.schemas import TenantLoginRequest, LoginResponse
...
def tenant_login(request: Request, login_data: TenantLoginRequest, db: Session = Depends(get_db)):
    ...
    response = LoginResponse(message="Login successful", role="tenant")
...
#     resp = JSONResponse(LoginResponse(message="Login successful", role="tenant").dict())
#     resp.set_cookie(
#         key="access_token",
#         value=access_token,
#         httponly=True,
